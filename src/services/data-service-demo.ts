...
export async function getDemoPlatformTable(
  platform: Platform,
  level: PlatformLevel,
  businessId: string,
...
export async function getDemoCreatives(
  businessId: string,
  filters?: {
    platforms?: Platform[];
    dateRange?: "7d" | "30d";
...
export async function getDemoCopies(
  businessId: string,
  filters?: {
    platform?: Platform;
    dateRange?: "7d" | "30d";
...
export async function getDemoIntegrations(
  businessId: string
