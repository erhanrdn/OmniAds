...
export const RELEASE_AUTHORITY_SURFACES: ReleaseAuthoritySurfaceDefinition[] = [
  ...
  },
  {
    ...
    references: [
      ...
      { kind: "doc", path: RELEASE_AUTHORITY_CANONICAL_DOC, label: "V3-01 authority doc" },
      { kind: "doc", path: "docs/operator-policy/creative-segmentation-recovery/archive/phase-04-creative-decision-os.md", label: "Phase 04 creative decision OS archive" },
