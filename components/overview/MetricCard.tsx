...
export function MetricCard({
  ...
  return (
    <article className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm shadow-slate-200/40">
      ...
      <div className="mt-3 rounded-xl border border-slate-200/80 bg-[linear-gradient(180deg,#fbfdff_0%,#f8fafc_100%)] p-3">
        {chartPoints.length > 1 ? (
          <div className="relative">
            <div className="flex items-start gap-2">
              <div className="pointer-events-none flex h-[84px] w-10 flex-col justify-between pt-1 text-[10px] text-slate-400">
                {yTicks.map((tick) => (
            ...
            {activePoint ? (
              <div
                className="pointer-events-none absolute top-1 rounded-lg border border-slate-200/90 bg-white/95 px-3 py-2 text-xs shadow-[0_10px_30px_rgba(15,23,42,0.08)] backdrop-blur-sm"
          ...
          <div className="h-[84px] rounded-lg bg-slate-100" />
        )}
      </div>
