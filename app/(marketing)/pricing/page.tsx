...
const PLANS = [
  {
    ...
    features: [
      { label: "Basic ad dashboard", included: true },
      { label: "Creative performance insights", included: true },
      { label: "Copy performance insights", included: true },
      { label: "Basic Google Ads insights", included: true },
      { label: "Limited AI recommendations", included: true },
      { label: "Limited GEO intelligence", included: true },
      { label: "Full AI recommendations", included: false },
      { label: "Advanced Google Ads intelligence", included: false },
      { label: "GEO intelligence insights", included: false },
      { label: "Export reports", included: false },
      { label: "Advanced GEO intelligence", included: false },
      { label: "Custom reporting", included: false },
      { label: "Team member roles", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Limited AI recommendations", included: true },
      { label: "Limited GEO intelligence", included: true },
      { label: "Full AI recommendations", included: true },
      { label: "Advanced Google Ads intelligence", included: true },
      { label: "GEO intelligence insights", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "GEO intelligence insights", included: true },
      { label: "Export reports", included: true },
      { label: "Advanced GEO intelligence", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Advanced GEO intelligence", included: true },
      { label: "Custom reporting", included: true },
      { label: "Team member roles", included: true },
...
const FAQS = [
  {
    ...
    a: "Yes. The Starter plan is free forever with no credit card required. You can connect 1 ad account, view 14 days of history, and access the core dashboards.",
  },
  {
  ...
  },
  {
    ...
    a: "Analytics history determines how far back Adsecute can pull data from your connected accounts. Starter includes 14 days, Growth includes 90 days, and Pro/Scale includes full available history.",
  },
  {
