    ...
    return (
      <div className="space-y-4">
        ...
        <div className="rounded-xl border border-red-200 bg-red-50 px-5 py-4">
          <p className="text-sm font-medium text-red-800">Entegrasyon detayları yuklenemedi.</p>
    ...
    <div className="space-y-8">
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-4">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
          ...
          <label className="inline-flex items-center gap-2 text-sm text-gray-600">
            ...
            />
            Sadece coklu-provider workspace'ler
          </label>
        </div>
      </div>
      ...
      {filteredGroups.length === 0 ? (
        <div className="rounded-xl border border-gray-200 bg-white px-5 py-10 text-center text-sm text-gray-400">
          Secili filtrelerle eslesen issue bulunamadi.
        </div>
      ) : (
        <div className="space-y-4">
