...
export default function AboutPage() {
  return (
    <PublicLegalPage title="About Us" subtitle="Built by operators, for operators.">
      <section>
      ...
      <section>
        <h2 className="text-xl font-semibold tracking-tight">Why We Built Adsecute</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-xl font-semibold tracking-tight">Contact &amp; Company</h2>
        <p className="mt-3">
          Adsecute is incorporated in the state of Delaware, United States.
        </p>
        <address className="mt-3 not-italic text-muted-foreground leading-6">
          Adsecute<br />
          8 The Green<br />
          Dover, DE 19901<br />
          United States
