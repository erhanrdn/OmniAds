...
function baseFixture(
  id: string,
  inputSummary: string,
  overrides: Partial<SpikeCreativeRow>,
): SpikeCreativeRow {
  return {
    creativeId: id,
...
const goldenCases: GoldenCase[] = [
  {
    id: "01",
    inputSummary:
      "active ad + active campaign/adset + 24h spend 0 + impressions 0",
    fixture: baseFixture("gc-01", "active no spend", {
      spend24h: 0,
      impressions24h: 0,
    }),
  ...
  },
  {
    ...
    fixture: baseFixture("gc-02", "paused campaign no spend", {
      campaignStatus: "PAUSED",
      spend24h: 0,
      impressions24h: 0,
      campaignContextBlockerFlags: ["campaign_paused"],
    }),
    expectedPrimaryDecision: "Diagnose",
  ...
  },
  {
    ...
    fixture: baseFixture("gc-03", "paused adset", {
      adsetStatus: "PAUSED",
      campaignContextBlockerFlags: ["adset_paused"],
    }),
    expectedPrimaryDecision: "Diagnose",
    expectedBuyerAction: "diagnose_data",
    expectedActionability: "diagnose",
  ...
  },
  {
    ...
    fixture: baseFixture("gc-04", "disapproved", {
      reviewStatus: "DISAPPROVED",
      effectiveStatus: "DISAPPROVED",
      disapprovalReason: "policy",
    }),
    expectedPrimaryDecision: "Diagnose",
  ...
  },
  {
    ...
    fixture: baseFixture("gc-05", "limited delivery", {
      effectiveStatus: "LIMITED",
      limitedReason: "text policy",
    }),
    expectedPrimaryDecision: "Diagnose",
    expectedBuyerAction: "fix_policy",
    expectedActionability: "diagnose",
  ...
  },
  {
    ...
    fixture: baseFixture("gc-06", "policy unknown", {
      reviewStatus: null,
  ...
  },
  {
    ...
    fixture: baseFixture("gc-07", "new launch low spend", {
      launchAgeHours: 36,
      spend: 30,
      purchases: 0,
      impressions: 1500,
  ...
  },
  {
    ...
    fixture: baseFixture("gc-08", "new launch enough spend no purchase", {
      launchAgeHours: 60,
      spend: 180,
      purchases: 0,
      recentPurchases: 0,
  ...
  },
  {
    ...
    fixture: baseFixture("gc-09", "new launch severe overspend", {
      launchAgeHours: 55,
      spend: 320,
      purchases: 0,
      cpa: 0,
  ...
  },
  {
    ...
    fixture: baseFixture("gc-10", "mature high spend loser", {
      launchAgeHours: 240,
      spend: 700,
      purchases: 1,
      roas: 0.25,
  ...
  },
  {
    ...
    fixture: baseFixture("gc-11", "mature winner", {
      beforePrimaryDecision: "promote_to_scaling",
      beforeOperatorBucket: "scale",
      beforeUserLabel: "Scale",
      launchAgeHours: 220,
      spend: 700,
      purchases: 12,
      roas: 2.2,
  ...
  },
  {
    ...
    fixture: baseFixture("gc-12", "winner fatigue", {
      beforePrimaryDecision: "refresh_replace",
      beforeOperatorBucket: "refresh",
      beforeUserLabel: "Refresh",
      launchAgeHours: 300,
      spend: 900,
      purchases: 9,
      roas: 1.3,
...
const extraCases: GoldenCase[] = [
  [
    "13",
    "CTR down but frequency flat and CPM flat",
    {
      ctr7d: 0.8,
      ctr14d: 1.3,
      cpm7d: 12,
    ...
    "medium",
    "medium",
    "partial_fatigue_signal",
    "actionable",
  ],
  [
    "14",
    "frequency up but CTR stable",
    { frequency7d: 2.2, frequency14d: 1.4, ctr7d: 1.2, ctr14d: 1.2 },
    "Test More",
    "test_more",
    "insufficient_signal",
    "medium",
  ...
  [
    "15",
    "CPM up but CPA/ROAS stable",
    { cpm7d: 18, cpm14d: 12, roas: 1.4, recentRoas: 1.4 },
    "Test More",
    "test_more",
    "insufficient_signal",
    "medium",
  ...
  [
    ...
    "benchmark missing",
    {
      activeBenchmarkRoas: null,
      activeBenchmarkCpa: null,
      baselineReliability: "unavailable",
      benchmarkReliability: "none",
    },
    "Diagnose",
    "diagnose_data",
    "data_quality",
    "medium",
    "low",
    "benchmark_context_not_strong",
    "learning",
  ],
  [
    "17",
    "benchmark weak",
    { baselineReliability: "weak", benchmarkReliability: "weak" },
    "Diagnose",
    "diagnose_data",
    "data_quality",
    "medium",
  ...
  [
    "19",
    "attribution/truth missing",
    {
      attributionTruth: "missing",
      trustState: "degraded_missing_truth",
      sourceTrustFlags: ["missing_truth"],
    },
    "Diagnose",
    "diagnose_data",
    "data_quality",
  ...
  [
    "20",
    "tracking drop suspected",
    {
      attributionTruth: "degraded",
      sourceTrustFlags: ["tracking_drop_suspected"],
    },
    "Diagnose",
    "diagnose_data",
    "data_quality",
  ...
  [
    "21",
    "high priority but low confidence delivery issue",
    {
      spend24h: 0,
      impressions24h: null,
      campaignStatus: null,
  ...
  [
    "22",
    "low maturity but high priority policy issue",
    {
      spend: 10,
      purchases: 0,
      reviewStatus: "DISAPPROVED",
  ...
  [
    "23",
    "mature data but low confidence due to attribution degradation",
    {
      launchAgeHours: 300,
      spend: 800,
      purchases: 8,
      attributionTruth: "degraded",
      trustState: "degraded_missing_truth",
      sourceTrustFlags: ["degraded_truth"],
    },
    "Diagnose",
    "diagnose_data",
    "data_quality",
  ...
  [
    "24",
    "active creative with spend but zero impressions anomaly",
    { spend24h: 20, impressions24h: 0 },
    "Diagnose",
    "diagnose_data",
    "data_quality",
    "high",
  ...
  [
    "25",
    "high CTR but poor CVR / landing issue",
    {
      ctr7d: 2.5,
      ctr14d: 2.2,
      spend: 400,
    ...
    "medium",
    "medium",
    "landing_or_cvr_issue",
    "actionable",
  ],
  [
    "26",
    "strong ROAS but tiny spend, not mature",
    { spend: 25, purchases: 1, roas: 4, recentRoas: 4, impressions: 1000 },
    "Test More",
    "test_more",
    "insufficient_signal",
    "medium",
  ...
  [
    "27",
    "strong CPA but low purchase count, not scalable yet",
    { spend: 120, purchases: 2, cpa: 45, roas: 2.1, recentRoas: 2.0 },
    "Test More",
    "test_more",
    "insufficient_signal",
    "medium",
  ...
  [
    ...
    "medium",
    "medium",
    "winner_gap_aggregate_only",
    "mature",
  ],
  [
    "30",
    "approved but unused creative exists",
    {
      activeStatus: false,
      effectiveStatus: "ACTIVE",
      approvedButUnused: true,
      spend: 0,
      purchases: 0,
      impressions: 0,
    },
    ...
    "medium",
    "medium",
    "unused_approved_aggregate_only",
    "too_early",
  ],
  [
    "31",
    "family winner aging with no backup variants",
    {
      hasBackupVariant: false,
      launchAgeHours: 500,
      spend: 1000,
      purchases: 10,
      roas: 1.8,
    ...
    "medium",
    "medium",
    "backup_variant_aggregate_only",
    "mature",
  ],
  [
    "32",
    "old challenger says scale_hard but V2 says Test More",
    {
      beforePrimaryDecision: "scale_hard",
      beforeOperatorBucket: "scale",
      beforeUserLabel: "Scale Hard",
      spend: 80,
      purchases: 2,
      roas: 3.5,
      impressions: 2000,
  ...
  [
    "33",
    "operator surface says act_now but V2 says Diagnose",
    {
      beforePrimaryDecision: "promote_to_scaling",
      beforeOperatorBucket: "act_now",
      beforeUserLabel: "Scale",
      sourceTrustFlags: ["missing"],
      trustState: "degraded_missing_truth",
    },
    "Diagnose",
    "diagnose_data",
  ...
  [
    "34",
    "old V1 stable_winner maps to V2 Protect",
    {
      beforePrimaryDecision: "hold_no_touch",
      beforeOperatorBucket: "protect",
      beforeUserLabel: "Protect",
      launchAgeHours: 300,
      spend: 700,
      purchases: 8,
      roas: 1.5,
  ...
  [
    "35",
    "old V1 fatigued_winner maps to V2 Refresh",
    {
      beforePrimaryDecision: "refresh_replace",
      beforeOperatorBucket: "refresh",
      beforeUserLabel: "Refresh",
  ...
  ([
    ...
    fixture: baseFixture(
      `gc-${id}`,
      String(summary),
      overrides as Partial<SpikeCreativeRow>,
    ),
    ...
    expectedSafeFallbackIfDataMissing:
      problemClass === "fatigue" ? "diagnose_data" : "diagnose_data",
  }),
);
...
function maturity(row: SpikeCreativeRow, config: SpikeConfig): Maturity {
  ...
  const spendMature =
    (row.spend ?? 0) >= targetCpa * config.minSpendForMaturityMultiplier;
  const purchaseMature = (row.purchases ?? 0) >= config.minPurchasesForScale;
  const impressionMature =
    (row.impressions ?? 0) >= config.minImpressionsForCtrReliability;
...
function missingCoreData(row: SpikeCreativeRow) {
  ...
  if (isMissing(row.benchmarkReliability) && isMissing(row.baselineReliability))
    missing.push("benchmarkReliability");
  return missing;
}

function hasPolicyProof(row: SpikeCreativeRow) {
  const status =
    `${row.reviewStatus ?? ""} ${row.effectiveStatus ?? ""}`.toUpperCase();
  return (
    status.includes("DISAPPROVED") ||
    status.includes("REJECTED") ||
    status.includes("LIMITED") ||
    Boolean(row.disapprovalReason || row.limitedReason)
  );
}

function hasPolicyFields(row: SpikeCreativeRow) {
  return (
    !isMissing(row.reviewStatus) ||
    !isMissing(row.effectiveStatus) ||
    !isMissing(row.disapprovalReason) ||
    !isMissing(row.limitedReason)
  );
}
...
function hasLaunchFields(row: SpikeCreativeRow) {
  return (
    !isMissing(row.launchAgeHours) ||
    !isMissing(row.firstSeenAt) ||
    !isMissing(row.firstSpendAt)
  );
}
...
function fatigueComposite(row: SpikeCreativeRow, config: SpikeConfig) {
  ...
  const ctrDrop =
    ((row.ctr14d! - row.ctr7d!) / Math.max(row.ctr14d!, 0.01)) * 100;
  const cpmIncrease =
    ((row.cpm7d! - row.cpm14d!) / Math.max(row.cpm14d!, 0.01)) * 100;
  const frequencyIncrease =
    ((row.frequency7d! - row.frequency14d!) /
      Math.max(row.frequency14d!, 0.01)) *
    100;
  return (
    ctrDrop >= config.fatigueCtrDropPct &&
    cpmIncrease >= config.fatigueCpmIncreasePct &&
    frequencyIncrease >= config.fatigueFrequencyIncreasePct
  );
}

function simulateV21Primary(
  row: SpikeCreativeRow,
  currentV2: CreativeDecisionOsV2Output,
  config: SpikeConfig,
  ...
  if (
    stale ||
    row.attributionTruth === "missing" ||
    row.attributionTruth === "degraded" ||
    ...
    return {
      ...
      confidence: Math.min(currentV2.confidence, 58),
      riskLevel: "high",
    };
  }
  ...
  if (
    ...
    return {
      ...
      actionability: "diagnose",
      problemClass: "campaign-context",
      reasonTags: ["campaign_or_adset_context_requires_review"],
      confidence: 72,
      riskLevel: "medium",
    };
  }
  if ((row.launchAgeHours ?? 9999) <= config.launchWindowHours) {
    return {
      ...
      problemClass: "insufficient-signal",
      reasonTags: [
        (row.spend ?? 0) > (row.targetCpa ?? 70) * 4 &&
        (row.purchases ?? 0) === 0
  ...
  if (
    rowMaturity !== "mature" &&
    ((row.roas ?? 0) > (row.targetRoas ?? 1.2) ||
      (row.cpa ?? 9999) < (row.targetCpa ?? 70))
  ) {
    return {
      ...currentV2,
      primaryDecision: "Test More",
      ...
      problemClass: "insufficient-signal",
      reasonTags: [
        (row.spend ?? 0) < 50 ? "tiny_spend_winner" : "low_purchase_count",
      ],
      confidence: 66,
      riskLevel: "medium",
    };
  ...
  if (
    rowMaturity === "mature" &&
    (row.roas ?? 0) >=
      (row.targetRoas ?? 1.2) * config.minRoasOverTargetForScale &&
    (row.purchases ?? 0) >= config.minPurchasesForScale
  ) {
    return {
      ...currentV2,
  ...
  if (
    rowMaturity === "mature" &&
    ((row.cpa ?? 0) >= (row.targetCpa ?? 70) * config.maxCpaOverTargetForCut ||
      (row.roas ?? 999) < (row.targetRoas ?? 1.2) * 0.5)
  ) {
    return {
      ...currentV2,
      primaryDecision: "Cut",
...
function adapt(
  ...
  let problemClass: ProblemClassV21 =
    v2.problemClass === "campaign-context"
      ? "campaign_context"
      : v2.problemClass === "data-quality"
        ? "data_quality"
        : v2.problemClass === "insufficient-signal"
          ? "insufficient_signal"
          : "performance";
  let topReasonTag = v2.reasonTags[0] ?? "unknown";
  let priorityBand: PriorityBand =
    v2.riskLevel === "critical"
      ? "critical"
      : v2.riskLevel === "high"
        ? "high"
        : "medium";
  ...
  if ((row.dataFreshnessHours ?? 0) > config.staleDataHours) {
    ...
    problemClass = "data_quality";
    topReasonTag =
      row.attributionTruth === "missing" ? "truth_missing" : "truth_degraded";
    priorityBand = "high";
    ...
    (row.launchAgeHours ?? 9999) <= config.launchWindowHours &&
    v2.primaryDecision !== "Diagnose"
  ) {
    ...
    problemClass =
      rowMaturity === "too_early" || rowMaturity === "learning"
        ? "insufficient_signal"
        : problemClass;
  } else {
    buyerAction = "diagnose_data";
    problemClass =
      problemClass === "campaign_context" ? "campaign_context" : "data_quality";
  }
  ...
  return {
    ...
    priorityBand,
    confidenceBand:
      missing.length > 0 || row.attributionTruth !== "ready" ? "low" : band,
...
function shadowRows(config: SpikeConfig) {
  return sampleRows.map((row) => {
    ...
    const beforeAggressive = ["scale", "act_now", "protect"].includes(
      row.beforeOperatorBucket,
    );
    const afterAggressive = ["scale", "cut"].includes(after.buyerAction);
    const conflict =
      (["scale", "protect", "act_now"].includes(row.beforeOperatorBucket) &&
        after.buyerAction === "cut") ||
      (["cut", "kill"].includes(row.beforeOperatorBucket) &&
        after.buyerAction === "scale");
    const changeType: ChangeType = conflict
      ? "conflict"
      : after.missingData.length > 0
        ? "fallback_due_to_missing_data"
        : row.beforeOperatorBucket === after.buyerAction ||
            row.beforeUserLabel
              .toLowerCase()
              .includes(after.buyerAction.replace("_", " "))
          ? "same_meaning"
    ...
    return {
      ...
      changeType,
      riskLevel:
        conflict || (afterAggressive && after.confidenceBand !== "high")
          ? "high"
          : after.missingData.length > 0
            ? "medium"
            : "low",
  ...
  return fields.map((field) => {
    ...
    return {
      ...
      missingReason:
        covered === rows.length
          ? null
          : "Field is not guaranteed by current V1/V2 row contracts; fixture simulates target V2.1 data.",
...
function eligibility(rows: SpikeCreativeRow[], config: SpikeConfig) {
  ...
  const count = (
    predicate: (row: ReturnType<typeof shadowRows>[number]) => boolean,
  ) => adapted.filter(predicate).length;
  return {
    totalCreatives: rows.length,
    scaleOrCutEligiblePercent:
      Math.round(
        (count(
          (row) =>
            row.afterBuyerAction === "scale" || row.afterBuyerAction === "cut",
        ) /
          rows.length) *
          10000,
      ) / 100,
    fixDeliveryEligiblePercent:
      Math.round(
        (count((row) => row.afterBuyerAction === "fix_delivery") /
          rows.length) *
          10000,
      ) / 100,
    fixPolicyEligiblePercent:
      Math.round(
        (count((row) => row.afterBuyerAction === "fix_policy") / rows.length) *
          10000,
      ) / 100,
    watchLaunchEligiblePercent:
      Math.round(
        (count((row) => row.afterBuyerAction === "watch_launch") /
          rows.length) *
          10000,
      ) / 100,
    fatigueRefreshEligiblePercent:
      Math.round(
        (count((row) => row.afterBuyerAction === "refresh") / rows.length) *
          10000,
      ) / 100,
    diagnoseDataPercent:
      Math.round(
        (count((row) => row.afterBuyerAction === "diagnose_data") /
          rows.length) *
          10000,
      ) / 100,
  };
...
function aggregateTest(rows: SpikeCreativeRow[], config: SpikeConfig) {
  ...
  rows.forEach((row) => {
    byFamily.set(row.familyId ?? "unknown", [
      ...(byFamily.get(row.familyId ?? "unknown") ?? []),
      row,
    ]);
  });
    ...
    aggregates: [
      {
        ...
        canEmitNow:
          fatigueRows.filter((row) => row.isTopCreative).length >=
          config.fatigueClusterTopN
            ? "conditional"
            : "no",
        count:
          fatigueRows.filter((row) => row.isTopCreative).length >=
          config.fatigueClusterTopN
            ...
            : 0,
        blockedBy:
          fatigueRows.length < config.fatigueClusterTopN
            ? ["topN fatigue proof insufficient in fixture/current contracts"]
            : [],
      ...
      },
      {
        ...
        canEmitNow: rows.some((row) => row.approvedButUnused)
          ? "conditional"
          : "no",
        count: rows.filter((row) => row.approvedButUnused).length,
        blockedBy: [
          "current MetaCreativeRow lacks reliable effectiveStatus + zero-delivery unused-approved distinction",
        ],
      ...
      },
      {
        ...
        count: Array.from(byFamily.values()).filter(
          (family) =>
            family.some((row) => fatigueComposite(row, config)) &&
            family.every((row) => row.hasBackupVariant === false),
        ).length,
...
function configSensitivity() {
  ...
  const compare = (label: string, rows: ReturnType<typeof shadowRows>) => {
    const changed = rows.filter(
      (row, index) =>
        row.afterBuyerAction !== defaultRows[index]?.afterBuyerAction,
    );
    return {
      config: label,
      decisionsChanged: changed.length,
      changedActions: changed.map((row) => ({
        creativeId: row.creativeId,
        action: row.afterBuyerAction,
        defaultAction: defaultRows.find(
          (base) => base.creativeId === row.creativeId,
        )?.afterBuyerAction,
      })),
      unsafeScaleCut: rows.filter(
        (row) =>
          ["scale", "cut"].includes(row.afterBuyerAction) &&
          row.afterConfidenceBand !== "high",
      ).length,
    };
  };
  return [
    compare("conservative", conservativeRows),
    compare("aggressive", aggressiveRows),
  ];
}
...
function summarizeShadow(rows: ReturnType<typeof shadowRows>) {
  ...
  return {
    ...
    fallbackDueToMissingData: count(
      (row) => row.changeType === "fallback_due_to_missing_data",
    ),
    ...
    highConfidenceRate:
      Math.round(
        (count((row) => row.afterConfidenceBand === "high") / rows.length) *
          10000,
      ) / 100,
...
writeJson("data-readiness-coverage", {
  fields: reports.dataCoverage,
